  ...
  describe "POST #create" do
    ...
    context "with invalid params" do
      it "assigns a newly created but unsaved study as @study" do
        post :create, {:study => invalid_attributes}, valid_session
        expect(assigns(:study)).to be_a_new(Study)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested study" do
        study = Study.create! valid_attributes
        put :update, {:id => study.to_param, :study => new_attributes}, valid_session
        study.reload
    ...
    context "with invalid params" do
      it "assigns the study as @study" do
        study = Study.create! valid_attributes
        put :update, {:id => study.to_param, :study => invalid_attributes}, valid_session
        expect(assigns(:study)).to eq(study)
      end
